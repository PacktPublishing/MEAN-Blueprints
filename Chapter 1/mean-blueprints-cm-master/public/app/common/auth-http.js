System.register(['angular2/core', 'angular2/http', 'rxjs/Observable', 'rxjs/Subject/BehaviorSubject', './headers'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, Observable_1, BehaviorSubject_1, headers_1;
    var AuthHttp;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AuthHttp = (function () {
                function AuthHttp(http) {
                    this._http = http;
                    this.isAuthenticated = new BehaviorSubject_1.BehaviorSubject(true);
                }
                AuthHttp.prototype.request = function (requestArgs, additionalArgs) {
                    ...
                    if (!req.headers) {
                        req.headers = headers_1.contentHeaders;
                    }
