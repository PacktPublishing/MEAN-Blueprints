System.register(['angular2/core', 'rxjs/Observable', '../common/headers', '../auth/auth-http', './contact'], function(exports_1, context_1) {
    "use strict";
            ...
            ContactService = (function () {
                ...
                ContactService.prototype.getAll = function () {
                    ...
                    return this._authHttp
                        ...
                        return data.map(function (contact) {
                            return new contact_1.Contact(contact._id, contact.email, contact.name, contact.city, contact.phoneNumber, contact.company, contact.createdAt);
                        });
                    })
                ...
                ContactService.prototype.getOne = function (id) {
                    ...
                    return this._authHttp
                        ...
                        .map(function (res) { return res.json(); })
                        .map(function (data) {
                        return new contact_1.Contact(data._id, data.email, data.name, data.city, data.phoneNumber, data.company, data.createdAt);
                    })
                ...
                ContactService.prototype.create = function (contact) {
                    return this._authHttp
                        .post("" + this._url, this._serialize(contact), { headers: headers_1.contentHeaders })
                        .map(function (res) { return res.json(); })
                        .map(function (data) {
                        return new contact_1.Contact(data._id, data.email, data.name, data.city, data.phoneNumber, data.company, data.createdAt);
                    });
                ...
                ContactService.prototype.update = function (contact) {
                    return this._authHttp
                        .put(this._url + "/" + contact._id, this._serialize(contact), { headers: headers_1.contentHeaders })
                        .map(function (res) { return res.json(); })
                        .map(function (data) {
                        return new contact_1.Contact(data._id, data.email, data.name, data.city, data.phoneNumber, data.company, data.createdAt);
                    });
                };
                ContactService.prototype.remove = function (contactId) {
                    var _this = this;
                    this._authHttp
                        .delete(this._url + "/" + contactId)
                        .subscribe(function () {
                        _this._dataStore.contacts.map(function (c, i) {
                            if (c._id === contactId) {
                                _this._dataStore.contacts.splice(i, 1);
                            }
                        });
                        _this._contactsObserver.next(_this._dataStore.contacts);
                    }, function (err) { return console.error(err); });
                };
                ContactService.prototype._serialize = function (data) {
